...
// ----- 주제: Pointlight 어떤 지점에서 사방으로 퍼지는 빛
...
export default function example() {
	...
	const light = new THREE.PointLight('white',1, 100,1);  // pointlight
	light.position.y=3;
	scene.add(light);
	
	const lightHelper = new THREE.PointLightHelper(light);  // light의 위치가 어딘지 시각적으로 보인다.
