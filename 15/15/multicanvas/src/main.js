...
scene1.set(() => {
	...
	// scene1.scene.add(light);   // scene1이 그자체로 씬은 아니다.
	scene1.camera.add(light);  //카메라에 플래시를 달아줌
...
scene2.set(() => {
	...
	light.position.set(-1, 2, 3);
	// scene1.scene.add(light);   // scene1이 그자체로 씬은 아니다.
	scene2.camera.add(light);  //카메라에 플래시를 달아줌
...
scene3.set(() => {
	...
	light.position.set(-1, 2, 3);
	// scene1.scene.add(light);   // scene1이 그자체로 씬은 아니다.
	scene3.camera.add(light);  //카메라에 플래시를 달아줌
